...
<head>
  ...
  <meta name="description" content="Introduction to Web Development with Twitter Bootstrap, WordPress & Visual Composer">
  ...
  <meta property="og:url"           content="" />
    ...
    <meta property="og:description"   content="Introduction to Web Development with Twitter Bootstrap, WordPress & Visual Composer" />
  ...
  <link rel="stylesheet" href="{{ asset('css/theme/black.css') }}" id="theme">
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <div class="reveal">
        ...
        <div class="slides" id="slidesD">
            <?php include(public_path('/slides/web-development-basics/slides.html')) ?>
        </div>
    </div>
